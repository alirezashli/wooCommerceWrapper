    ...
    public class RestAPI
    {
        ...
        public async Task<string> SendHttpClientRequest<T>(string endpoint, RequestMethod method, T requestBody, Dictionary<string, string> parms = null)
        {
            ...
            try
            {
                ...
                // var t = await httpWebRequest.GetResponseAsync();
                //WebResponse wr1 = t;
                ...
                HttpWebResponse wr1 = null;
                try
                {
                    wr1 = (HttpWebResponse)await httpWebRequest.GetResponseAsync().ConfigureAwait(false);
                }
                catch (Exception)
                {
                ...
                if (webResponseFilter != null)
                    webResponseFilter.Invoke((HttpWebResponse)wr1);

                return await GetStreamContent(wr1.GetResponseStream(), wr1.ContentType.Contains("=") ? wr1.ContentType.Split('=')[1] : "UTF-8").ConfigureAwait(false);
            }
